...
class SystemInterfaceState(MutableModel):
    ...
    chat_image_snapshots: ChatImageSnapshotStore
    ...
    def shutdown(self) -> None:
        ...
        self.chat_image_snapshots.stop()
        try:
